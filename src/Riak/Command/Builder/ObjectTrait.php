...
namespace Widda\Riak\Command\Builder;
...
trait ObjectTrait
{
     ...
     *
     * @param \Widda\Riak\DataObject $object
     *
     * @return $this
     */
    ...
    {
        $this->object = new DataObject($data, ['Content-Type' => 'application/json']);
