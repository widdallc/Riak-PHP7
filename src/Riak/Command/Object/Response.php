...
namespace Widda\Riak\Command\Object;

use Widda\Riak\Location;
use Widda\Riak\DataObject;
...
{
    /**
     * @var \Widda\Riak\DataObject|null
     */
    protected $object = NULL;

    /**
     * @var \Widda\Riak\DataObject[]
     */
    protected $siblings = [];
    ...
    private function parseSiblings()
    {
        ...
        foreach ($parts as $part) {
            ...
            $this->siblings[] = new DataObject($data, $headers);
        }
    }
    ...
    /**
     * @return \Widda\Riak\DataObject|null
     */
