...
namespace Widda\Riak\Command;

use Widda\Riak;
use Widda\Riak\Command;
use Widda\Riak\DataType;

/**
 * This class follows the Builder design pattern and is the preferred method for creating Widda\Riak\Command
 ...
 *      ->withDataObject(new Object('test_data'))
